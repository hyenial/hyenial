...
- 🥇 [Celonis App Creator Certification](https://www.credly.com/badges/4504484c-900a-4963-9c7d-3fc7e8d00084/linked_in)
- 🏆 [Celonis Implementation Professional](https://www.credly.com/badges/e8f3e33b-36f0-4c1b-84aa-2fe967e69f2f/public_url)
...
`Spring Boot` `Flask` `Bootstrap` `Pandas` `Angular` `JSON` `YAML`

**Tools & Platforms**  
`Celonis EMS` `UiPath RPA` `AWS` `Linux`
...
[LinkedIn](https://www.linkedin.com/in/harun-rpa) | [Credly](https://www.credly.com/users/harun)
